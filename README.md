...
- **NewMan**
  ---------
 - Είναι υπεύθυνη για όλο το UI
- **AppMain**
  ---------
 - Ορίζει ποια main θα τρέξει
 - Αν δοθούν ορίσματα τοτε τρέχει το πρώτο μέρος τής εγαρμογης με βάση τα ορίσματα που δέχθηκε
 - Αν δεν δοθολυν ορίσματα τρέχει το δεύτερο μέρος οπού ο χρήστης εισάγει απο εκεί τα αρχεία
### org.huacoach.data
...
να πάτε στο out/artifacts (στον οποίο φάκελο υπάρχουν δυο αρχεία tcx) και επείτα μπορείτε να τρέξετε τις εξής εντολές:
...
Εάν θέλετε να τέξετε την εφαρμογή με το **ui**, τότε αυτό γίνεται με την ακόλουθη εντολή:

- java -jar AssistantCoach.jar
